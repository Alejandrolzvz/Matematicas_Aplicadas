...
data_tool  <- select(data_tool, stage045, stage061, stage056, stage043, stage038, stage094, stage089, stage081, stage090, stage008, stage002, stage040, stage055, stage068, stage051, stage058, stage088, stage013, stage031, stage057, CP)

#Start of ridge regression

x <- select(data_tool, -CP)
x <- as.matrix(x)
...
#fitting the moddel with the training data
...
#Calculate MSE related to best lambda
